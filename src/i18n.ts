...
const en: Dict = {
  ...
  'setting.authorShow': 'Show author bar',
  'setting.authorShowDesc': 'Preconfigure the author bar used when Export Studio opens.',
  'setting.authorAvatar': 'Avatar',
  'setting.authorName': 'Name',
  'setting.authorRemark': 'Bio',
  'setting.authorAlign': 'Alignment',
  'setting.watermarkEnable': 'Enable watermark',
  'setting.watermarkEnableDesc': 'Preconfigure the watermark used when Export Studio opens.',
...
const zh: Dict = {
  ...
  'setting.authorShow': '显示作者栏',
  'setting.authorShowDesc': '预配置打开导出工作室时的作者栏。',
  'setting.authorAvatar': '头像',
  'setting.authorName': '名称',
  'setting.authorRemark': '简介',
  'setting.authorAlign': '对齐',
  'setting.watermarkEnable': '启用水印',
  'setting.watermarkEnableDesc': '预配置打开导出工作室时的水印。',
