...
const en: Dict = {
  ...
  'setting.authorPreconfigDesc':
    'Filled when the author bar is turned on in Export Studio. Enable/disable stays in the studio.',
  ...
  'setting.watermarkPreconfigDesc':
    'Filled when the watermark is turned on in Export Studio. Enable/disable stays in the studio.',
