...
const en: Dict = {
  ...
  'studio.width': 'Width',
  'studio.previewMaxHeight': 'Max preview height',
  'studio.previewAlign': 'Preview align',
  'studio.previewAlign.center': 'Center',
  'studio.previewAlign.left': 'Left',
  ...
  'setting.paddingDesc': 'Default margins used when opening Export Studio. Use “document padding” in the studio to override once.',
  'setting.previewMaxHeight': 'Default max preview height',
  'setting.previewMaxHeightDesc': '0 = auto (preview width fills 100%). When set, taller images shrink to this height and width adapts.',
  'setting.previewAlign': 'Default preview align',
...
const zh: Dict = {
  ...
  'studio.fidelity': '保真',
  'studio.width': '宽度',
  'studio.previewMaxHeight': '预览最大高度',
  'studio.previewAlign': '预览对齐',
  'studio.previewAlign.center': '居中',
  'studio.previewAlign.left': '居左',
  'studio.scale': '分辨率',
  'studio.format': '格式',
  'studio.theme': '主题',
  ...
  'setting.paddingDesc': '打开导出工作室时使用的默认边距。可在工作室内点「使用文档边距」临时覆盖。',
  'setting.previewMaxHeight': '默认预览最大高度',
  'setting.previewMaxHeightDesc': '0 = 自动（预览宽度占满 100%）。设置后若图片更高，则高度受限、宽度自适应。',
  'setting.previewAlign': '默认预览对齐',
